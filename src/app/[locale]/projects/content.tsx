...
const fallbackProjects: SanityProject[] = [
  ...
  { title: 'ABM Outreach System', slug: { current: 'abm-outreach' }, subtitle_nl: 'Gepersonaliseerde B2B outreach op schaal', subtitle_en: 'Personalized B2B outreach at scale', description_nl: 'Een volledig geautomatiseerd Account-Based Marketing systeem dat gepersonaliseerde emails, branded CVs en landing pages genereert per bedrijf.', description_en: 'A fully automated Account-Based Marketing system that generates personalized emails, branded CVs and landing pages per company.', color: '#EF476F', techStack: ['Apollo.io', 'Mailgun', 'Claude AI', 'YakPDF', 'Supabase', 'Next.js'], featured: true, pageUrl: '/abm-outreach' },
